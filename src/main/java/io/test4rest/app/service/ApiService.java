...
public abstract class ApiService {
    public abstract ApiResponse callApi(ApiRequest request);

    protected StringBuilder getQueryParam(ApiRequest request) {
    ...
    protected void addRequestHeaders(HttpURLConnection httpURLConnection, ApiRequest request) {
    ...
    protected void addRequestBodyToHttpURLConnection(HttpURLConnection httpURLConnection, ApiRequest request) throws IOException {
    ...
    protected void addResponseHeaders(HttpURLConnection httpURLConnection, ApiResponse response) {
    ...
    protected String getResponseBody(InputStream inputStream) throws IOException {
