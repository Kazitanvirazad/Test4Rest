...
public final class HttpStatusCodeMapper {
    ...
    static {
        ...
        statusCodes.put(487, "Precondition Required");
    ...
    public static String getStatusCodeValue(int statusCode) {
        return statusCodes.getOrDefault(statusCode, EMPTY_STRING);
    }
}
